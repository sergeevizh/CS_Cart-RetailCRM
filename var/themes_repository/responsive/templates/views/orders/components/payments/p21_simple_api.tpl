...
<div class="ty-control-group">
    ...
    <input id="last4ssn" maxlength="4" size="35" type="text" name="payment_info[last4ssn]" value="{$cart.payment_info.last4ssn}" class="ty-input-text-medium cm-autocomplete-off cm-focus" />
</div>
<div class="ty-control-group">
