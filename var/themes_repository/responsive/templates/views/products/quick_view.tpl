        ...
        {hook name="products:view_main_info"}
            {if $product}
                ...
                {hook name="products:quick_view_image_wrap"}
                    {if !$no_images}
                        <div class="ty-product-block__img cm-reload-{$obj_prefix}{$obj_id}" style="width:{$thumbnail_width|default:$thumbnail_height}px; height: {$thumbnail_height|default:$thumbnail_width}px;" id="product_images_{$obj_prefix}{$obj_id}_update">
                        ...
                        {hook name="products:quick_view_title"}
                            {if !$hide_title}
                                <h1 class="ty-product-block-title">
                                    <a href="{$product_detail_view_url|fn_url}" class="ty-quick-view__title" {live_edit name="product:product:{$product.product_id}"}>{$product.product nofilter}</a>
                                </h1>
                            {/if}
                        {/hook}
