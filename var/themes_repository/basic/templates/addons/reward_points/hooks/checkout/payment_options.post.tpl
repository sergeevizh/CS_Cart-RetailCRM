...
<div class="coupons-container">
    <div id="point_payment" class="code-input discount-coupon">
        ...
        <div class="discount-info">
            ...
            <span class="block">{__("text_point_in_account")}&nbsp;{__("points_lowercase", [$user_info.points])}.</span>
