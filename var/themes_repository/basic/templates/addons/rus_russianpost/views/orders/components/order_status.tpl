{if $data_tracking}
    <div id="content_pochta_information">
        <a class="cm-ajax ty-btn" href="{"orders.details&order_id=`$order_info.order_id`"|fn_url}" data-ca-event="ce.update_object_status_callback">{__("shipping.russianpost.search_tracking_number")}</a>
        <hr />
