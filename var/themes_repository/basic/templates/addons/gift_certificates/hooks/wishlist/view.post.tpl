    ...
    <td class="product-cell valign-top" style="width: {$cell_width}%">
        <div class="product-cell-wrapper">
            <div class="wishlist-remove-item">
                <a href="{"gift_certificates.wishlist_delete?gift_cert_wishlist_id=`$gift_key`"|fn_url}" class="cm-post remove" title="{__("remove")}"><i class="icon-cancel-circle"></i><span>{__("remove")}</span></a>
            </div>
