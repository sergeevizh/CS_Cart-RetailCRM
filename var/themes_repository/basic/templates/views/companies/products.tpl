...
{capture name="mainbox_title"}<span class="mainbox-title">{$_title}</span><span class="mainbox-title right" id="products_search_total_found_{$block.block_id}">{$title_extra nofilter}<!--products_search_total_found_{$block.block_id}--></span>{/capture}
{/hook}