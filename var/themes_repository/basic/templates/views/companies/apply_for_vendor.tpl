...
{if !$auth.user_id && $settings.Vendors.create_vendor_administrator_account == "Y"}
    ...
    <div class="control-group shipping-first-name" id="company_description_admin_firstname">
        ...
        <input type="text" name="company_data[admin_firstname]" id="company_admin_firstname" size="32" value="{$company_data.admin_firstname}" class="input-text"/>
    </div>
    <div class="control-group shipping-last-name" id="company_description_admin_lastname">
        ...
        <input type="text" name="company_data[admin_lastname]" id="company_admin_lastname" size="32" value="{$company_data.admin_lastname}" class="input-text"/>
    </div>
