...
{capture name="mainbox_title"}<span class="float-right" id="products_search_total_found_{$block.block_id}">{$title_extra nofilter}<!--products_search_total_found_{$block.block_id}--></span>{__("search_results")}{/capture}
{/hook}