...
{if $order_info.points_info.in_use}
    <tr>
        <td style="text-align: right; white-space: nowrap; font-size: 12px; font-family: Arial;"><b>{__("points_in_use")}</b>&nbsp;({__("points_lowercase", [$order_info.points_info.in_use.points])})<b>:</b>&nbsp;</td>
