<?php /* Smarty version Smarty-3.1.21, created on 2016-07-13 13:20:56
         compiled from "/var/www/local.s3.prefest.ru/design/backend/templates/views/index/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:21228267205786160808a3c7-81006894%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b5c035d10f51b0f12fde4633e6d912bce72c1572' => 
    array (
      0 => '/var/www/local.s3.prefest.ru/design/backend/templates/views/index/index.tpl',
      1 => 1466664541,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '21228267205786160808a3c7-81006894',
  'function' => 
  array (
    'get_orders' => 
    array (
  ...
  'unifunc' => 'content_578616084ee129_03042556',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_578616084ee129_03042556')) {function content_578616084ee129_03042556($_smarty_tpl) {?><?php if (!is_callable('smarty_block_inline_script')) include '/var/www/local.s3.prefest.ru/app/functions/smarty_plugins/block.inline_script.php';
if (!is_callable('smarty_block_hook')) include '/var/www/local.s3.prefest.ru/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_enum')) include '/var/www/local.s3.prefest.ru/app/functions/smarty_plugins/modifier.enum.php';
...
%
    ...
    <?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/local.s3.prefest.ru/app/functions/smarty_plugins/modifier.date_format.php';
...
"><?php echo $_smarty_tpl->__('show_all');?>
                ...
                <?php if (!is_callable('smarty_block_hook')) include '/var/www/local.s3.prefest.ru/app/functions/smarty_plugins/block.hook.php';
...
$_tmp5=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['link_storefront'] = new Smarty_variable("http://".$_tmp5, null, 0);?>
        <?php } else { ?>
            <?php ob_start();
echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['config']->value['http_location']), ENT_QUOTES, 'UTF-8');
$_tmp6=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['link_storefront'] = new Smarty_variable($_tmp6, null, 0);?>
        <?php }?>
