<?php /* Smarty version Smarty-3.1.21, created on 2016-07-13 13:26:27
         compiled from "/var/www/local.s3.prefest.ru/design/backend/templates/views/companies/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:28644813257861753b724d4-71407424%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '44cce354e68dcbd3a92a26daf84cbdad8442a1d2' => 
    array (
      0 => '/var/www/local.s3.prefest.ru/design/backend/templates/views/companies/manage.tpl',
      1 => 1466664541,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '28644813257861753b724d4-71407424',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57861753ce9b46_57169515',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57861753ce9b46_57169515')) {function content_57861753ce9b46_57169515($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/local.s3.prefest.ru/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_unpuny')) include '/var/www/local.s3.prefest.ru/app/functions/smarty_plugins/modifier.unpuny.php';
    ...
    <td class="nowrap">
        ...
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"companies:list_extra_links")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"companies:list_extra_links"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <?php if (!$_smarty_tpl->tpl_vars['runtime']->value['company_id']&&fn_check_view_permissions("companies.update","POST")) {?>
                ...
                <?php } else { ?>
                    <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-confirm",'href'=>"companies.delete?company_id=".((string)$_smarty_tpl->tpl_vars['company']->value['company_id'])."&redirect_url=".((string)$_smarty_tpl->tpl_vars['return_current_url']->value),'text'=>__("delete"),'method'=>"POST"));?>
</li>
                <?php }?>
            <?php }?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
    <?php if (fn_allowed_for("ULTIMATE:FREE")) {?>
        <?php echo $_smarty_tpl->getSubTemplate ("common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('tool_override_meta'=>"btn cm-promo-popup",'tool_href'=>"#",'prefix'=>"top",'hide_tools'=>true,'title'=>__("add_vendor"),'icon'=>"icon-plus"), 0);?>
