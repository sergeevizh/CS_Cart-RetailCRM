        ...
        $.ceAjax('request', fn_url('theme_editor.view'), {
            ...
            callback: function() {
                ...
                $('#theme_editor').on('click', '.cm-te-google-font', function() {
                    ...
                    $('link:last').after('<link href="//fonts.googleapis.com/css?family=' + font_name + ('weight' in font_data ? ':' + font_data['weight'] : '') + '&subset=latin,cyrillic" rel="stylesheet" type="text/css">');
