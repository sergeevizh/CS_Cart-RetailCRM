...
<div class="ty-control-group">
    ...
    <input type="text" name="total_sec_from" value="{$search.total_sec_from}" size="3" class="ty-input-text-short" />&nbsp;&#8211;&nbsp;<input type="text" name="total_sec_to" value="{$search.total_sec_to}" size="3" class="ty-input-text-short" />
</div>
