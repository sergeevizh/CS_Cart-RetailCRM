    ...
    <script type="text/javascript">
        ...
        var exchangeRate = {
            ...
            getRate: function (from, to, callback) {
                ...
                script.setAttribute('src', "//query.yahooapis.com/v1/public/yql?q=select%20rate%2Cname%20from%20csv%20where%20url%3D'http%3A%2F%2Fdownload.finance.yahoo.com%2Fd%2Fquotes%3Fs%3D" + from + to + "%253DX%26f%3Dl1n'%20and%20columns%3D'rate%2Cname'&format=json&callback=" + callback);
            ...
            parseExchangeRate: function(data) {
                ...
                if(rate !== 0 && name != this.primary_currency) {
                    ...
                    container.append('<li>' + name + ' <span class="pull-right muted">' + rate + '</span></li>');
