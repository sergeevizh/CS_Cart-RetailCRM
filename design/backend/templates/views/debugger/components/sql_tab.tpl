        ...
        <table class="deb-table" id="DebugToolbarSubTabSQLListTable">
            ...
            {foreach from=$data.list item="query" key="key"}
                ...
                <tr>
                    ...
                    <td class="{if $color}{$color}{/if}"><a
                                href="{"debugger.sql_parse?debugger_hash=`$debugger_hash`&sql_id=`$key`"|fn_url}"
                                ca-data-target-id="DebugToolbarSubTabSQLParse"
                                data-ca-target-id="DebugToolbarSubTabSQLParse" class="cm-ajax cm-ajax-cache query">
