{include file="common/pagination.tpl" search=$features_search div_id="product_features_pagination_`$product_id`" current_url="products.get_features?product_id=`$product_id`&multiple=1&over=$over&data_name=$data_name"|fn_url disable_history=true}
