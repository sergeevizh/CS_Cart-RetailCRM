    ...
    <td class="nowrap">
        <div class="hidden-tools">
            {capture name="tools_list"}
                <li>{btn type="list" class="cm-confirm" text=__("delete") href="product_options.delete_combination?combination_hash=`$i.combination_hash`&product_id=`$product_id`" method="POST"}</li>
            {/capture}
...
{capture name="buttons"}
    {capture name="tools_list"}
        <li>{btn type="list" text=__("rebuild_combinations") href="product_options.rebuild_combinations?product_id=`$product_id`" method="POST"}</li>
        {if $inventory}
            <li class="divider"></li>
