...
{if $settings.Checkout.address_position == 'shipping_first'}
    <div id="profile_fields_s">
        {include file="views/profiles/components/profile_fields.tpl" user_data=$user_data section="S" title=__("shipping_address")}
    </div>
    <div id="profile_fields_b">
        {include file="views/profiles/components/profile_fields.tpl" user_data=$user_data section="B" title=__("billing_address") body_id="bi" shipping_flag=$profile_fields|fn_compare_shipping_billing ship_to_another=$cart.ship_to_another}
    </div>
{else}
    <div id="profile_fields_b">
