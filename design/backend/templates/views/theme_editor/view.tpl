...
<a href="{"customization.disable_mode?type=theme_editor"|fn_url}" class="te-close cm-te-close-editor" title="{__("theme_editor.close")}"><i class="glyph-cancel icon-cancel"></i></a>
        </span>
</span>
                ...
                <div>
                    {if $field.properties.color}
                        ...
                        <div class="te-color-picker-container te-colors clearfix">
                            ...
                            <a id="sw_backgrounds_adv_color_{$name}" class="cm-combination te-advanced-options"><i class="glyph-cog"></i></a>
                            {/if}
                    ...
                    {if $field.properties.pattern}
                        <div class="te-bg-pattern-group clearfix">
                            ...
                            <a id="sw_backgrounds_adv_pattern_{$name}" class="te-advanced-options cm-combination"><i class="glyph-cog"></i></a>
                                    ...
                                    <div class="te-bg-position-wrap clearfix">
                                        {strip}
                                            <div class="te-bg-position-item">
                                                ...
                                                <label for="top_left"><i class="glyph-arrow-up-left"></i></label>
                                            </div>
                                            ...
                                            <label for="top_center"><i class="glyph-arrow-up"></i></label></div>
                                            ...
                                            <label for="top_right"><i class="glyph-arrow-up-right"></i></label></div>
                                        {/strip}
                                    </div>
                                    <div class="te-bg-position-wrap clearfix">
                                        {strip}
                                            <div class="te-bg-position-item">
                                                ...
                                                <label for="center_left"><i class="glyph-arrow-left"></i></label>
                                            </div>
                                            <div class="te-bg-position-item">
                                                ...
                                                <label for="center_center"><i class="glyph-square"></i></label>
                                            </div>
                                            <div class="te-bg-position-item">
                                                ...
                                                <label for="center_right"><i class="glyph-arrow-right"></i></label>
                                            </div>
                                        {/strip}
                                    </div>
                                    <div class="te-bg-position-wrap clearfix">
                                        {strip}
                                            <div class="te-bg-position-item">
                                                ...
                                                <label for="bottom_left"><i class="glyph-arrow-down-left"></i></label>
                                            </div>
                                            <div class="te-bg-position-item">
                                                ...
                                                <label for="bottom_center"><i class="glyph-arrow-down"></i></label>
                                            </div>
                                            <div class="te-bg-position-item">
                                                ...
                                                <label for="bottom_right"><i class="glyph-arrow-down-right"></i></label>
                                            </div>
                                        {/strip}
                                    </div>
                                </div>
