                        ...
                        {foreach from=$order_info.shipping item="shipping" key="shipping_id" name="f_shipp"}
                            ...
                            {else}
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input id="tracking_number" class="input-small" type="text" name="update_shipping[{$shipping.group_key}][{$shipment_id}][tracking_number]" size="45" value="{$shipments[$shipping.group_key].tracking_number}" />
    ...
    <div class="btn-group btn-hover dropleft">
        ...
        <ul class="dropdown-menu">
            ...
            {hook name="orders:notify_checkboxes"}
                <li><a><input type="checkbox" name="notify_user" {if $notify_customer_status == true} checked="checked" {/if} id="notify_user" value="Y" />
                    {__("notify_customer")}</a></li>
                <li><a><input type="checkbox" name="notify_department" {if $notify_department_status == true} checked="checked" {/if} id="notify_department" value="Y" />
                    {__("notify_orders_department")}</a></li>
                {if "MULTIVENDOR"|fn_allowed_for}
                <li>
                    <a><input type="checkbox" name="notify_vendor" {if $notify_vendor_status == true} checked="checked" {/if} id="notify_vendor" value="Y" />
                        {__("notify_vendor")}</a>
                </li>
                {/if}
            {/hook}
