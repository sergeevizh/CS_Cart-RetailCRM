...
<div class="control-group cm-no-hide-input">
    <label for="locations_ids" class="control-label">{__("block_manager.layout_pages")}</label>
    <div class="controls">
        <div class="scroll-y">
...
<div class="buttons-container">
    {include file="buttons/save_cancel.tpl" but_text=__("export") but_name="dispatch[block_manager.export_layout]" cancel_action="close"}
</div>
</form>