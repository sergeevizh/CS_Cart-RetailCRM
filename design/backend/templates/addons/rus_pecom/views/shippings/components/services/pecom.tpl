...
<div class="control-group">
	<label class="control-label" for="pecom_height">{__("ship_height")}:</label>
	<div class="controls">
...
<div class="control-group">
	<label class="control-label" for="pecom_width">{__("ship_width")}:</label>
	<div class="controls">
...
<div class="control-group">
	<label class="control-label" for="pecom_length">{__("ship_length")}:</label>
	<div class="controls">
