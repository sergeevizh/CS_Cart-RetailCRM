...
<fieldset>
    ...
    {* Show product code *}
    <div class="form-field control-group">
        <label class="control-label" for="elm_tw_show_product_code">{__("twgadmin_show_product_code")}:</label>
        <div  class="controls">
    ...
    <div class="form-field control-group">
        <label class="control-label" for="elm_tw_send_order_status_push">{__("twgadmin_send_push")}:</label>
        <div  class="controls">
...
<script type="text/javascript">
    //<![CDATA[
    var current_store_is_connected = {if $twg_is_connected}true{else}false{/if};
    {literal}
