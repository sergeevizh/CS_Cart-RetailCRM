...
<div class="cm-tabs-content">
    ...
    <fieldset>
        ...
        <div class="control-group">
            <label class="control-label" for="elm_mailing_list_show_on_registration_{$id}">{__("addons.newsletters.show_on_registration_and_profile")}</label>
            <div class="controls">
        ...
        {if $id}
            <div class="control-group">
                ...
                {include file="buttons/button.tpl" but_text=__("manage_subscribers") but_href="subscribers.manage?list_id=`$id`" but_role="text"}
                </div>
            </div>
        {/if}
