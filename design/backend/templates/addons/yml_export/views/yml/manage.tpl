{capture name="mainbox"}
    ...
    {assign var="allow_save" value=$price|fn_allow_save_object:"yml_export"}
        ...
        {if $price_lists}
            <table class="table table-middle">
                ...
                <tr class="cm-row-status-{$price.status|lower}">
                    ...
                    <td class="right">
                        {include file="common/select_popup.tpl" id=$price.param_id status=$price.status hidden=true object_id_name="param_id" table="yml_param" popup_additional_class="`$no_hide_input` dropleft" hidden=false}
                    </td>
                </tr>
                {/foreach}
            </table>
