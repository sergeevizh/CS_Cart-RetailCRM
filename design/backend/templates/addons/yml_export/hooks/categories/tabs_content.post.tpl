<div id="content_yml">
    <div id="yml2_addon" class="in collapse">
        ...
        <div class="control-group cm-no-hide-input">
            <label for="yml2_parent_market_category" class="control-label">{__("yml_export.parent_market_category")}:</label>
            ...
            <div class="controls" id="yml2_parent_market_category">
                <input type="checkbox" name="category_data[yml2_parent_market_category]" value="Y" {if $category_data.yml2_parent_market_category == "Y"} checked="checked"{/if} class="cm-toggle-checkbox"/></br>
            </div>
        </div>
    </div>
</div>
