<div id="content_yml">
    ...
    <div id="acc_general" class="collapse in">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="hidden" name="product_data[yml2_exclude_export]" value="" />
        ...
        <div class="control-group">
            ...
            <div class="controls"><input type="text" name="product_data[yml2_brand]" id="yml2_brand" size="55" value="{$product_data.yml2_brand}" class="input-text-large" />
        ...
        <div class="control-group">
            <label class="control-label" for="elm_yml_product_descr">{__("description")}:</label>
            <div class="controls">
                {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='yml2_description' name="update_all_vendors[yml2_description]"}
        ...
        <div id="yml2_model_div" class="control-group">
            ...
            <div class="controls"><input type="text" name="product_data[yml2_model]" id="yml2_model" size="55" value="{$product_data.yml2_model}" class="input-text-large" {if (!empty($yml2_model_category))}placeholder="{$yml2_model_category}"{/if}/>
                {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='product' name="update_all_vendors[product]"}
            </div>
        </div>
        ...
        <div id="yml2_type_prefix_div" class="control-group">
            ...
            <div class="controls"><input type="text" name="product_data[yml2_type_prefix]" id="yml2_type_prefix" size="55" value="{$product_data.yml2_type_prefix}" class="input-text-large"  {if (!empty($yml2_type_prefix_category))}placeholder="{$yml2_type_prefix_category}"{/if}/>
                {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='product' name="update_all_vendors[product]"}
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls"><input type="text" name="product_data[yml2_sales_notes]" id="yml2_sales_notes" size="50" value="{$product_data.yml2_sales_notes}" class="input-text-large" />
                {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='product' name="update_all_vendors[product]"}</div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls"><input type="text" name="product_data[yml2_origin_country]" id="yml2_country" size="55" value="{$product_data.yml2_origin_country}" class="input-text-large" />
                {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='product' name="update_all_vendors[product]"}</div>
        </div>

        <div class="control-group">
            <label for="yml2_manufacturer_warranty" class="control-label">{__("yml2_manufacturer_warranty")}:</label>
            <div class="controls"><input type="text" name="product_data[yml2_manufacturer_warranty]" id="yml2_manufacturer_warranty" size="55" value="{$product_data.yml2_manufacturer_warranty}" class="input-text-large" />
                {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='product' name="update_all_vendors[product]"}</div>
        </div>

        <div class="control-group">
            <label for="yml2_seller_warranty" class="control-label">{__("yml2_seller_warranty")}:</label>
            <div class="controls"><input type="text" name="product_data[yml2_seller_warranty]" id="yml2_seller_warranty" size="55" value="{$product_data.yml2_seller_warranty}" class="input-text-large" />
                {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='product' name="update_all_vendors[product]"}</div>
        </div>

        <div class="control-group">
            <label for="yml2_expiry" class="control-label">{__("yml2_expiry")}:</label>
            <div class="controls"><input type="text" name="product_data[yml2_expiry]" id="yml2_expiry" size="55" value="{$product_data.yml2_expiry}" class="input-text-large" />
                {include file="buttons/update_for_all.tpl" display=$show_update_for_all object_id='product' name="update_all_vendors[product]"}</div>
        </div>
