...
if ($mode == 'manage') {
    ...
    $selected_fields[] = array('name' => '[data][yml_adult]', 'text' => __('yml_adult'));
    ...
    if (!empty($selected_fields['data']['yml_adult'])) {
        $field_groups['S']['yml_adult']['name'] = 'products_data';
        $field_groups['S']['yml_adult']['variants'] = array(
            'N' => 'no',
            'Y' => 'yes',
        );
        $filled_groups['S']['yml_adult'] = __('yml_adult');
        unset($field_names['yml_adult']);
    }
