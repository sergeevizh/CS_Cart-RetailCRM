...
REPLACE INTO ?:seo_names (`name`, `object_id`, `company_id`, `type`, `dispatch`, `lang_code`) VALUES('compare', 0, 0, 's', 'product_features.compare', 'en');
REPLACE INTO ?:seo_names (`name`, `object_id`, `company_id`, `type`, `dispatch`, `lang_code`) VALUES('tags', 0, 0, 's', 'tags.summary', 'en');
REPLACE INTO ?:seo_names (`name`, `object_id`, `company_id`, `type`, `dispatch`, `lang_code`) VALUES('returns', 0, 0, 's', 'rma.returns', 'en');
REPLACE INTO ?:seo_names (`name`, `object_id`, `company_id`, `type`, `dispatch`, `lang_code`) VALUES('orders', 0, 0, 's', 'orders.search', 'en');
