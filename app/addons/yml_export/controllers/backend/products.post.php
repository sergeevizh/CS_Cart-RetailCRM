...
if ($mode == 'manage') {
    ...
    $selected_fields[] = array('name' => '[data][yml2_brand]', 'text' => __('yml2_brand'));
    $selected_fields[] = array('name' => '[data][yml2_offer_type]', 'text' => __('yml2_offer_type'));
    $selected_fields[] = array('name' => '[data][yml2_origin_country]', 'text' => __('yml2_country'));
    $selected_fields[] = array('name' => '[data][yml2_store]', 'text' => __('yml2_store'));
    $selected_fields[] = array('name' => '[data][yml2_pickup]', 'text' => __('yml2_pickup'));
    $selected_fields[] = array('name' => '[data][yml2_delivery]', 'text' => __('yml2_delivery'));
    $selected_fields[] = array('name' => '[data][yml2_adult]', 'text' => __('yml2_adult'));
    $selected_fields[] = array('name' => '[data][yml2_exclude_price_ids]', 'text' => __('yml_export.yml2_exclude_export'));
    $selected_fields[] = array('name' => '[data][yml2_bid]', 'text' => __('yml2_bid'));
    $selected_fields[] = array('name' => '[data][yml2_cbid]', 'text' => __('yml2_cbid'));
    $selected_fields[] = array('name' => '[data][yml2_model]', 'text' => __('yml2_model'));
    $selected_fields[] = array('name' => '[data][yml2_market_category]', 'text' => __('yml2_market_category'));
    $selected_fields[] = array('name' => '[data][yml2_sales_notes]', 'text' => __('yml2_sales_notes'));
    $selected_fields[] = array('name' => '[data][yml2_type_prefix]', 'text' => __('yml2_type_prefix'));
    $selected_fields[] = array('name' => '[data][yml2_manufacturer_warranty]', 'text' => __('yml2_manufacturer_warranty'));
    $selected_fields[] = array('name' => '[data][yml2_seller_warranty]', 'text' => __('yml2_seller_warranty'));
    ...
    if (!empty($selected_fields['data']['yml2_brand'])) {
        ...
        $filled_groups['A']['yml2_brand'] = __('yml2_brand');
    ...
    if (!empty($selected_fields['data']['yml2_offer_type'])) {
        ...
        $filled_groups['S']['yml2_offer_type'] = __('yml2_offer_type');
    ...
    if (!empty($selected_fields['data']['yml2_sales_notes'])) {
        ...
        $filled_groups['A']['yml2_sales_notes'] = __('yml2_sales_notes');
    ...
    if (!empty($selected_fields['data']['yml2_market_category'])) {
        ...
        $filled_groups['A']['yml2_market_category'] = __('yml2_market_category');
    ...
    if (!empty($selected_fields['data']['yml2_type_prefix'])) {
        ...
        $filled_groups['A']['yml2_type_prefix'] = __('yml2_type_prefix');
    ...
    if (!empty($selected_fields['data']['yml2_origin_country'])) {
        ...
        $filled_groups['A']['yml2_origin_country'] = __('yml2_country');
    ...
    if (!empty($selected_fields['data']['yml2_store'])) {
        ...
        $filled_groups['S']['yml2_store'] = __('yml2_store');
    ...
    if (!empty($selected_fields['data']['yml2_pickup'])) {
        ...
        $filled_groups['S']['yml2_pickup'] = __('yml2_pickup');
    ...
    if (!empty($selected_fields['data']['yml2_delivery'])) {
        ...
        $filled_groups['S']['yml2_delivery'] = __('yml2_delivery');
    ...
    if (!empty($selected_fields['data']['yml2_adult'])) {
        ...
        $filled_groups['S']['yml2_adult'] = __('yml2_adult');
    ...
    if (!empty($selected_fields['data']['yml2_cost'])) {
        ...
        $filled_groups['A']['yml2_cost'] = __('yml2_cost');
    ...
    if (!empty($selected_fields['data']['yml2_bid'])) {
        ...
        $filled_groups['A']['yml2_bid'] = __('yml2_bid');
        unset($field_names['yml2_bid']);
    }

    if (!empty($selected_fields['data']['yml2_cbid'])) {
        $field_groups['A']['yml2_cbid'] = 'products_data';
        $filled_groups['A']['yml2_cbid'] = __('yml2_cbid');
        unset($field_names['yml2_cbid']);
    }

    if (!empty($selected_fields['data']['yml2_model'])) {
        $field_groups['A']['yml2_model'] = 'products_data';
        $filled_groups['A']['yml2_model'] = __('yml2_model');
        unset($field_names['yml2_model']);
    }
    
    if (!empty($selected_fields['data']['yml2_manufacturer_warranty'])) {
        $field_groups['A']['yml2_manufacturer_warranty'] = 'products_data';
        $filled_groups['A']['yml2_manufacturer_warranty'] = __('yml2_manufacturer_warranty');
        unset($field_names['yml2_manufacturer_warranty']);
    }
    
    if (!empty($selected_fields['data']['yml2_seller_warranty'])) {
        $field_groups['A']['yml2_seller_warranty'] = 'products_data';
        $filled_groups['A']['yml2_seller_warranty'] = __('yml2_seller_warranty');
        unset($field_names['yml2_seller_warranty']);
    }
