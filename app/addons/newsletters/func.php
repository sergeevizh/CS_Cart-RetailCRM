...
function fn_send_newsletter($to, $from, $subj, $body, $attachments = array(), $lang_code = CART_LANGUAGE, $reply_to = '')
{
    ...
    $mailer_settings = Registry::get('addons.newsletters');

    if ($mailer_settings['mailer_send_method'] == 'default') {
        // Empty array given to Mailer::instance() forces using default mailing settings
        $mailer_settings = array();
    } else {
        $mailer_settings = array(
            'mailer_send_method' => $mailer_settings['mailer_send_method'],
            'mailer_smtp_host' => $mailer_settings['mailer_smtp_host'],
            'mailer_smtp_username' => $mailer_settings['mailer_smtp_username'],
            'mailer_smtp_password' => $mailer_settings['mailer_smtp_password'],
            'mailer_smtp_ecrypted_connection' => $mailer_settings['mailer_smtp_ecrypted_connection'],
            'mailer_smtp_auth' => $mailer_settings['mailer_smtp_auth'],
        );
    }
