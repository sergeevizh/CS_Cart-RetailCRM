 ...
 *
 * @param \Tygh\Addons\AXmlScheme $addon_scheme      Data from addon.xml file
...
function fn_get_addon_layouts_path($addon_name, $theme_name = '[theme]')
{
    ...
    $theme_addon_layouts_path = fn_get_theme_path("[themes]/{$theme_name}/layouts/addons/{$addon_name}/layouts.xml", 'C');
    if (file_exists($theme_addon_layouts_path)) {
        $addon_layouts_path = $theme_addon_layouts_path;
        unset($theme_addon_layouts_path);
