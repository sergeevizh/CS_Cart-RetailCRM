...
$schema['top']['administration']['items']['stores_divider'] = array(
    'type' => 'divider',
    'position' => 91
);
...
if (Registry::get('runtime.company_id') && !Registry::get('runtime.simple_ultimate')) {
    unset($schema['top']['settings']['items']['Emails'], $schema['top']['settings']['items']['Shippings'], $schema['top']['settings']['items']['Stores'], $schema['top']['settings']['items']['Upgrade_center']);
}
