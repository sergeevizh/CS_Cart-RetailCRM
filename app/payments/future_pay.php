...
if (defined('PAYMENT_NOTIFICATION')) {
    ...
    if (strpos($result, 'FP_') === false) {
        ...
        Tygh::$app['view']->assign('script_url', $script_url);
        Tygh::$app['view']->assign('return_url', $return_url);
        Tygh::$app['view']->assign('continue_url', $continue_url);

        Tygh::$app['view']->display('views/checkout/processors/future_pay.tpl');
