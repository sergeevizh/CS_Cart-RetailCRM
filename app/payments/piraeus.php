...
if (defined('PAYMENT_NOTIFICATION')) {
    ...
    if ($mode == 'notify') {
        ...
        if (!empty(Tygh::$app['session']['stored_piraeus_orderid'])) {
            $order_id = Tygh::$app['session']['stored_piraeus_orderid'];
            unset(Tygh::$app['session']['stored_piraeus_orderid']);
        } else {
...
EOT;
    ...
    if ($resultcode == "0") {
        ...
        Tygh::$app['session']['stored_piraeus_orderid'] = $order_id;
