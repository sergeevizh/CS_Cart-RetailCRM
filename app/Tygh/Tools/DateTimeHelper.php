...
class DateTimeHelper
{
    ...
    public static function getPeriodDefinitions()
    {
        return array(
            ...
            self::PERIOD_THIS_WEEK => array(
                'from' => 'this week 00:00:00',
                'to' => 'this week +6 days 23:59:59',
            ),
            self::PERIOD_LAST_WEEK => array(
                'from' => 'previous week 00:00:00',
                'to' => 'previous week +6 days 23:59:59',
            ),
    ...
    public static function getTimeZoneOffsetString($time_zone_name)
    {
        ...
        $tz_offset = $tz->getOffset(new DateTime('now', new DateTimeZone('UTC')));

        return self::formatTimeZoneOffsetString($tz_offset);
    }
