...
class Fedex implements IService
{
     ...
     */
    private function prepareShippingInfo($request, $address, $address_type_key, $code = '')
    {
...
EOT;
    ...
    public function getRequestData()
    {
        ...
        $fedex_options = $this->prepareShippingInfo($fedex_options, $this->_shipping_info['package_info']['origination'], 'Shipper');
        $fedex_options = $this->prepareShippingInfo($fedex_options, $this->_shipping_info['package_info']['location'], 'Recipient', $code);
